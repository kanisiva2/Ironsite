    ...
    <div className="border-t border-border bg-surface p-4">
      ...
      <form onSubmit={handleSubmit} className="flex items-end gap-2">
        ...
        <textarea
          ...
          rows={1}
          disabled={disabled}
          className="max-h-32 min-h-[42px] flex-1 resize-none rounded-lg border border-border bg-surface-alt px-4 py-2.5 text-text outline-none transition-colors focus:border-primary focus:ring-2 focus:ring-primary-light disabled:opacity-50"
